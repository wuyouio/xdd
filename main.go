...
import (
	...
	"github.com/wuyouio/xdd/controllers"
	"github.com/wuyouio/xdd/models"
	"github.com/wuyouio/xdd/qbot"
)
...
func main() {
	...
	web.Get("/", func(ctx *context.Context) {
		if models.Config.Theme == "" {
			models.Config.Theme = models.GhProxy + "https://raw.githubusercontent.com/wuyouio/xdd/main/theme/bidong.html"
		}
		if theme != "" {
